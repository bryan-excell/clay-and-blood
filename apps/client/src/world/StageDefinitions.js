 ...
 */
import { STATIC_STAGE_LAYOUTS } from '@clay-and-blood/shared';
...
const _staticStages = {
    ...
    'town-square': {
        ...
        connections: {
            2: { levelId: 'west-gate', exitIndex: 1 },
            4: { levelId: 'inn',        exitIndex: 0 },
        },
    },
    ...
    'west-gate': {
        ...
        connections: {
            1: { levelId: 'town-square', exitIndex: 2 },
        },
    },
    ...
    'inn': {
        ...
        connections: {
            0: { levelId: 'town-square', exitIndex: 4 },
        },
    },
};
