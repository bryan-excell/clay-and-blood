export class HpBarWidget {
    constructor(scene, x = 16, y = 16) {
        ...
        this._label = scene.add.text(this.x, this.y - 18, 'HP', {
            fontSize: '14px',
        ...
        this._fill = scene.add.rectangle(this.x + 2, this.y + 2, this.width - 4, this.height - 4, 0x44aa66, 1)
            .setOrigin(0, 0);

        this._valueText = scene.add.text(this.x + this.width - 8, this.y + this.height / 2, '0 / 0', {
            fontSize: '12px',
            fontFamily: 'monospace',
            color: '#ffffff',
            stroke: '#000000',
    ...
    setPosition(x, y) {
        this.x = x;
        this.y = y;
        this._label.setPosition(x, y - 18);
        this._frame.setPosition(x, y);
        this._fill.setPosition(x + 2, y + 2);
        this._valueText.setPosition(x + this.width - 8, y + this.height / 2);
    }
